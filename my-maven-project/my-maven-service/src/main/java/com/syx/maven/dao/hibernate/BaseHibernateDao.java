package com.syx.maven.dao.hibernate;
...
import com.syx.maven.util.BeanUtils;
import com.syx.maven.util.GenericsUtils;
import com.syx.maven.util.HibernateQueryUtil;
